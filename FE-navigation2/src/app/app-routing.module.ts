...
export const AppRoutes = {
  ...
  app: {
    ...
    organCatalog: '/app/organ',
    organDetail: '/app/organ/:organId',
    systemCatalog: '/app/system',
    systemDetail: '/app/system/:systemId',
    sampleOrganImage: '/app/organ/:organId/:sampleId',
    sampleSystemImage: '/app/system/:systemId/:sampleId',
    addToFavourite: '',
